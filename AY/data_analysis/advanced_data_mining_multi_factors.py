...
ranking_setup = {"pb": True,
                 "ps": True,
                 "cash_to_market_cap": False,
                 "pe": True,
                 "price_to_op_cash_flow": True,
                 "gross_profit_over_assets": False,
                 "q_sales_yoy": False}
...
def mine():
    ...
    df = df.assign(Expected_return=lambda x: (x.deep_value + x.current_value + x.fundamental) / 3)
