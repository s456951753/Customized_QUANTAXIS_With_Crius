create index ind_adj_factor_1990_1994_id on adj_factor_1990_1994(id);
...
create index ind_adj_factor_1995_1999_id on adj_factor_1995_1999(id);
...
create index ind_adj_factor_2000_2004_id on adj_factor_2000_2004(id);
...
create index ind_adj_factor_2005_2009_id on adj_factor_2005_2009(id);
...
create index ind_adj_factor_2010_2014_id on adj_factor_2010_2014(id);
...
create index ind_adj_factor_2015_2019_id on adj_factor_2015_2019(id);
...
create index ind_adj_factor_2020_2024_id on adj_factor_2020_2024(id);
